// Menubtns is responsible for rendering mobile view menu
...
const Minimu = (props) => {
  return (
    ...
    <div className="close" onClick={()=>{props.MiniMenuContr_close()}}><i className="far fa-window-close"></i></div>
